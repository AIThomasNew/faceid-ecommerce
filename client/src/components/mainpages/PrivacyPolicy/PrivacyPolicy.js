    ...
    return (
        <div className="privacy-policy-container">
            ...
            <p>
                ...
                действует в отношении всей информации, которую сайт Центр перманентного макияжа FACE ID, (далее – FACE
                ID) расположенный на доменном имени faceidpermanent.ru (а также его субдоменах), может получить о
                Пользователе во время использования сайта faceidpermanent.ru (а также его субдоменов), его программ и
                его продуктов.
            </p>
            ...
            <p>
                ...
                Центр перманентного макияжа FACE ID, действующие от имени ИП Абашева Ирина Сергеевна, которые организуют
                и (или) осуществляют обработку персональных данных, а также определяет цели обработки персональных
            ...
            <p>
                1.1.5. «Сайт Центр перманентного макияжа FACE ID» - это совокупность связанных между собой веб-страниц,
                размещенных в сети Интернет по уникальному адресу (URL): faceidpermanent.ru, а также его субдоменах.
            </p>
            <p>
                1.1.6. «Субдомены» - это страницы или совокупность страниц, расположенные на доменах третьего уровня,
                принадлежащие сайту Центр перманентного макияжа FACE ID, а также другие временные страницы, внизу
                который указана контактная информация Администрации
            </p>
            <p>
                1.1.5. «Пользователь сайта Центр перманентного макияжа FACE ID » (далее Пользователь) – лицо, имеющее
                доступ к сайту Центр перманентного макияжа FACE ID, посредством сети Интернет и использующее информацию,
                материалы и продукты сайта Центр перманентного макияжа FACE ID.
            </p>
            <p>
            ...
            <p>
                2.1. Использование сайта Центр перманентного макияжа FACE ID Пользователем означает согласие с настоящей
            ...
            <p>
                ...
                использование сайта Центр перманентного макияжа FACE ID .
            </p>
            <p>
                2.3. Настоящая Политика конфиденциальности применяется к сайту Центр перманентного макияжа FACE ID. FACE
                ID не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь может
                перейти по ссылкам, доступным на сайте Центр перманентного макияжа FACE ID.
            </p>
            ...
            <p>
                ...
                запросу Администрации при регистрации на сайте Центр перманентного макияжа FACE ID, при подписке на
            ...
            <p>
                ...
                предоставляются Пользователем путём заполнения форм на сайте Центр перманентного макияжа FACE ID и
            ...
            <p>3.3. FACE ID защищает Данные, которые автоматически передаются при посещении страниц:</p>
            <ul>
                <li> - IP адрес; </li>
            ...
            <p>
                3.3.2. FACE ID осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация
            ...
            <p>
                4.1.1. Идентификации Пользователя, зарегистрированного на сайте Центр перманентного макияжа FACE ID для
                его дальнейшей авторизации, оформления заказа и других действий.
            </p>
            <p>
                4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта Центр перманентного
                макияжа FACE ID.
            </p>
            <p>
                4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов,
                касающихся использования сайта Центр перманентного макияжа FACE ID, оказания услуг и обработки запросов
            ...
            <p>
                4.1.6. Создания учетной записи для использования частей сайта Центр перманентного макияжа FACE ID, если
            ...
            <p>
                ...
                связанных с использованием сайта Центр перманентного макияжа FACE ID.
            </p>
            <p>
                4.1.9. Предоставления Пользователю с его согласия специальных предложений, информации о ценах, новостной
                рассылки и иных сведений от имени сайта Центр перманентного макияжа FACE ID.
            </p>
            ...
            <p>
                ...
                Центр перманентного макияжа FACE ID, включая доставку Товара, документации или e-mail сообщений.
            </p>
            <p>
            ...
            <p>
                5.4. При утрате или разглашении персональных данных Администрация вправе не информировать Пользователя
            ...
            <p>
                5.6. Администрация совместно с Пользователем принимает все необходимые меры по предотвращению убытков
            ...
            <p>
                ...
                использования сайта Центр перманентного макияжа FACE ID, и давать согласие на их обработку.
            </p>
            <p>
            ...
            <p>
                ...
                файлы с данными, тексты и т. д.), к которой он может иметь доступ как к части сайта Центр перманентного
                макияжа FACE ID, несет лицо, предоставившее такую информацию.
            </p>
            <p>
                7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта Центр перманентного
                макияжа FACE ID, может являться объектом интеллектуальной собственности, права на который защищены и
                принадлежат другим Пользователям, партнерам или рекламодателям, которые размещают такую информацию на
                сайте Центр перманентного макияжа FACE ID. Пользователь не вправе вносить изменения, передавать в
                аренду, передавать на условиях займа, продавать, распространять или создавать производные работы на
                основе такого Содержания (полностью или в части), за исключением случаев, когда такие действия были
                письменно прямо разрешены собственниками такого Содержания в соответствии с условиями отдельного
                соглашения.
            </p>
            <p>
                7.6. В отношение текстовых материалов (статей, публикаций, находящихся в свободном публичном доступе на
                сайте Центр перманентного макияжа FACE ID) допускается их распространение при условии, что будет дана
                ссылка на FACE ID.
            </p>
            <p>
                ...
                коммуникационных данных, содержащихся на сайте Центр перманентного макияжа FACE ID или передаваемых
                через него.
            </p>
            <p>
            ...
            <p>
                ...
                Центр перманентного макияжа FACE ID, включая, но не ограничиваясь: информацию, защищенную авторским
            ...
            <p>8.3. При не достижении соглашения спор будет передан на рассмотрение Арбитражного суда г. Пермь.</p>
            <p>
            ...
            <p>
                9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте Центр
                перманентного макияжа FACE ID, если иное не предусмотрено новой редакцией Политики конфиденциальности.
            </p>
            <p>
                9.3. Все предложения или вопросы касательно настоящей Политики конфиденциальности следует сообщать по
                адресу: faceidpermanent@yandex.ru
            </p>
            <p>
                9.4. Действующая Политика конфиденциальности размещена на странице по адресу
                http://faceidpermanent.ru/privacy-policy
            </p>
            Обновлено: 06 Ноября 2022 года г. Пермь, ИП Абашева И. С., ОГРН: 321595800088301
        </div>
    )
}
